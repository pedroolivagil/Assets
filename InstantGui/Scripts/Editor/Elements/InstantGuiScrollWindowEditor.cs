...
[CustomEditor(typeof(InstantGuiScrollWindow))]
class InstantGuiScrollWindowEditor : InstantGuiElementEditor{
    public override void OnInspectorGUI(){
        ...
        script.guiElementProps = EditorGUILayout.Foldout(script.guiElementProps, "WindowScroll");
        if (script.guiElementProps){
            ...
            script.closeButton = (InstantGuiElement) EditorGUILayout.ObjectField("Close Button:", script.closeButton,
                typeof(InstantGuiElement), true);
